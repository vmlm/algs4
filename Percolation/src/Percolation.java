...
public class Percolation {
    ...
    */
     ...
     * In this case we have three bits of information for each connected component:
     * 
     * -> The first indicates whether the site is open.
     * -> The second indicates whether it is connected to the top (filled).
     * -> the third indicates whether it is connected to the basin.
     * 
     * When a connected component has all three bits set to 1, 
